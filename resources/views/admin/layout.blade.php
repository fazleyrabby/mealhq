                    ...
                    <ul class="navbar-nav pt-lg-3">
                        ...
                        <li class="nav-item {{ request()->routeIs('admin.offers.*') ? 'active' : '' }}">
                            <a class="nav-link" href="{{ route('admin.offers.index') }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>
                                </span>
                        ...
                        <!-- Staff -->
                        @php($staffActive = request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*'))
                        <li class="nav-item dropdown {{ $staffActive ? 'active show' : '' }}">
                            <a class="nav-link dropdown-toggle {{ $staffActive ? 'show' : '' }}" href="#navbar-staff" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ $staffActive ? 'true' : 'false' }}">
                                <span class="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
                                </span>
                                <span class="nav-link-title">Staff</span>
                            </a>
                            <ul class="dropdown-menu {{ $staffActive ? 'show' : '' }}" data-bs-popper="none">
                                <li><a class="dropdown-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}" href="{{ route('admin.users.index') }}">Users</a></li>
                                <li><a class="dropdown-item {{ request()->routeIs('admin.roles.*') ? 'active' : '' }}" href="{{ route('admin.roles.index') }}">Roles &amp; Permissions</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
