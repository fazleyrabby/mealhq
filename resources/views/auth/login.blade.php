    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-gray-900">MealHQ Admin</h1>
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <a href="{{ route('admin.demo.login') }}"
                       class="block text-center px-4 py-2 bg-amber-500 text-white rounded-lg text-sm font-medium hover:bg-amber-600 transition-colors">
                        Demo Admin
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <a href="{{ route('demo.login.customer') }}"
                       class="block text-center px-4 py-2 bg-blue-500 text-white rounded-lg text-sm font-medium hover:bg-blue-600 transition-colors">
                        Demo Customer
                    </a>
                </div>
